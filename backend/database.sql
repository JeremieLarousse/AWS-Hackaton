...
START TRANSACTION;
USE `aws`;
INSERT INTO `aws`.`Voiture` (`idVoiture`, `immatriculation`, `maintenance`, `marque`, `modele`, `type`, `date`, `disponible`, `autonomie`, `Destination_idGarage`, `Mission_idMission`, `Utilisateur_idUtilisateur`) VALUES (1, 'ES-991-RL', 0, 'RENAULT', 'Clio', 'voiture', '2020-11-12', 1, '500', 1, 1, 1);
INSERT INTO `aws`.`Voiture` (`idVoiture`, `immatriculation`, `maintenance`, `marque`, `modele`, `type`, `date`, `disponible`, `autonomie`, `Destination_idGarage`, `Mission_idMission`, `Utilisateur_idUtilisateur`) VALUES (2, 'RT-123-YA', 1, 'RENAULT', 'Megane', 'berline', '2021-12-20', 0, '800', 2, 2, 2);
INSERT INTO `aws`.`Voiture` (`idVoiture`, `immatriculation`, `maintenance`, `marque`, `modele`, `type`, `date`, `disponible`, `autonomie`, `Destination_idGarage`, `Mission_idMission`, `Utilisateur_idUtilisateur`) VALUES (3, 'SD-588-CV', 0, 'PEUGEOT', 'C4', 'utilitaire', '2019-05-05', 0, '1000', 6, 4, 3);
INSERT INTO `aws`.`Voiture` (`idVoiture`, `immatriculation`, `maintenance`, `marque`, `modele`, `type`, `date`, `disponible`, `autonomie`, `Destination_idGarage`, `Mission_idMission`, `Utilisateur_idUtilisateur`) VALUES (4, 'Rainbow', 0, 'LICORNE', 'Multicolore', '4 pattes', '2000-01-01', 1, '1000000', 7, 3, 4);
INSERT INTO `aws`.`Voiture` (`idVoiture`, `immatriculation`, `maintenance`, `marque`, `modele`, `type`, `date`, `disponible`, `autonomie`, `Destination_idGarage`, `Mission_idMission`, `Utilisateur_idUtilisateur`) VALUES (5, 'UO-247-NG', 1, 'RENAULT', 'K2021', 'Camion', '2016-06-08', 0, '1600', 2, 2, 2);
